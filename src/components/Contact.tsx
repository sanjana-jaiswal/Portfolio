...
import { Mail, MapPin, Download, Send, Check, Phone } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4 font-body text-sm text-text-secondary">
                    ...
                    <div>
                      ...
                      <a href="tel:+918840436673" className="hover:text-accent transition-colors">
                        +91 8840436673
                      </a>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                ...
                {/* Resume Download */}
                <a
                  href="/Sanjana-Jaiswal-Resume.pdf"
                  download="Sanjana-Jaiswal-Resume.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
